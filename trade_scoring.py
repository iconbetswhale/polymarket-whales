...
def _exclusion_record(
    ...
    return {
        ...
        "event_start_time": primary.get("resolution_time"),
        ...
        "period": primary.get("period") or primary.get("period_id"),
        "market_line": primary.get("market_line") or primary.get("line"),
        "provider": primary.get("provider") or "polymarket",
        "settlement_scope": primary.get("settlement_scope"),
        "settlement_rules": primary.get("settlement_rules"),
